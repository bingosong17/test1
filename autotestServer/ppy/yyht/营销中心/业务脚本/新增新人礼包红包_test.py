...
from yyht.营销中心.api.新人礼包红包_test import TestCase新人礼包红包 as 新人礼包红包
...
class TestCase新增新人礼包红包(HttpRunner):
    ...
    teststeps = [
        Step(
            RunTestCase("新人礼包红包").call(新人礼包红包)
