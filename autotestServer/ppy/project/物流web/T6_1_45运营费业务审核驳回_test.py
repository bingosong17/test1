...
from yyht.物流中心.运力管理.api.业务审核驳回_test import TestCase业务审核驳回 as 业务审核驳回
from yyht.物流中心.运力管理.api.查询司机列表_test import TestCase查询司机列表 as 司机查询

class TestCase运营费业务审核驳回(HttpRunner):
    ...
    teststeps = [
        ...
        Step(
            RunTestCase("业务审核驳回").with_variables(
                **{
                    # "operateCostDetailId":["$id"]
